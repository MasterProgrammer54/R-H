import{ap as U,aq as Te,ar as ke,as as ye,at as Ee,au as Ae,av as ee,aw as Oe,ax as Ue,ay as Ie,az as xe,c as Ne,a as $,h as Pe,d as Ce}from"./index.fe2533e2.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const be="storage";function Qt(e,t,n){return e=U(e),Bt(e,t,n)}function Jt(e){return e=U(e),$t(e)}function en(e){return e=U(e),Mt(e)}function tn(e){return e=U(e),qt(e)}function nn(e){return e=U(e),Ht(e)}function sn(e,t){return e=U(e),zt(e,t)}function rn(e=ye(),t){e=U(e);const s=Te(e,be).getImmediate({identifier:t}),r=ke("storage");return r&&Xt(s,...r),s}function Xt(e,t,n,s={}){Kt(e,t,n,s)}function Gt(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new J(n,s,r,t,Ue)}function Yt(){Ee(new Ae(be,Gt,"PUBLIC").setMultipleInstances(!0)),ee(oe,ie,""),ee(oe,ie,"esm2017")}Yt();var on=Ne({name:"QItemLabel",props:{overline:Boolean,caption:Boolean,header:Boolean,lines:[Number,String]},setup(e,{slots:t}){const n=$(()=>parseInt(e.lines,10)),s=$(()=>"q-item__label"+(e.overline===!0?" q-item__label--overline text-overline":"")+(e.caption===!0?" q-item__label--caption text-caption":"")+(e.header===!0?" q-item__label--header":"")+(n.value===1?" ellipsis":"")),r=$(()=>e.lines!==void 0&&n.value>1?{overflow:"hidden",display:"-webkit-box","-webkit-box-orient":"vertical","-webkit-line-clamp":n.value}:null);return()=>Pe("div",{style:r.value,class:s.value},Ce(t.default))}});export{on as Q,tn as a,Jt as b,nn as d,rn as g,en as l,sn as r,Qt as u};
